...
export function AddNote({ onAddNote }) {
  ...
  function onTogglePinChange(event) {
    ...
    setNewNote((prevNote) => ({ ...prevNote, isPinned: pinState }))
  }
  ...
  function handleChange({ target }) {
    ...
    if (field === "title")
      ...
      setNewNote((prevNote) => ({
        ...prevNote,
        info: { title: prevNote.info.title, [field]: value },
      }))
    else
      setNewNote((prevNote) => ({
        ...prevNote,
    ...
    <div className="note add-note" style={bgStyle} onClick={toggleAddOpen}>
      ...
      {addOpen && (
        <div className="add-toolbar">
          <span
            className="add-color material-symbols-outlined"
            title="Add color"
          ...
          <span
            className="add-txt material-symbols-outlined"
            title="Add text"
            onClick={() => onChangeNoteType("NoteTxt")}
          >
            text_format
          </span>
          <span
            className="add-img material-symbols-outlined"
            title="Add image"
            onClick={() => onChangeNoteType("NoteImg")}
          >
            image
          </span>
          <span
            className="add-vid material-symbols-outlined"
            title="Add video"
            onClick={() => onChangeNoteType("NoteVid")}
          >
            movie
          </span>
